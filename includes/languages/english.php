...
define('TEXT_EXT_SEND_AS_GROUP','Send as one grouped email (all recipients visible)');
define('TEXT_EXT_SEND_AS_GROUP_INFO','If checked, one single email will be sent with all recipients visible in To/CC/BCC. If unchecked, each recipient gets an individual email (default behaviour).');
