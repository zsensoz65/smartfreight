        ...
        switch($position)
        {
            ...
            case 'default':
                ...
                foreach($buttons_list as $buttons)
                {
                    ...
                    {
                        $html .= '<li>' . button_tag($buttons['button_title'], url_for('items/processes_warning', 'id=' . $buttons['id'] . '&path=' . $app_path), true, array('class' => 'btn btn-primary btn-sm btn-process-' . $buttons['id'] . $css), $buttons['button_icon']) . '</li>';
                        $html .= $this->prepare_button_css($buttons);
                    }
                }
            ...
            case 'comments_section':
                ...
                foreach($buttons_list as $buttons)
                {
                    ...
                    elseif($this->button_has_warnign_text($buttons))
                    {
                        $html .= button_tag($buttons['button_title'], url_for('items/processes_warning', 'id=' . $buttons['id'] . '&path=' . $app_path), true, array('class' => 'btn btn-primary btn-sm btn-process-' . $buttons['id'] . $css), $buttons['button_icon']);
                        $html .= $this->prepare_button_css($buttons);
                    }
                }
                break;
