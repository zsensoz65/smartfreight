                ...
                foreach($filters as $field_id => $field_value)
                {
                    ...
                    else
                    {
                        ...
                        if($field_info = db_fetch_array($field_info_query))
                        {
                            ...
                            {                                
                                if(is_string($filters['filters_values']) and $filters['filters_condition']=='search')
                                {   
                                    $obj = ['fields_id'=>$field_info['id'],'filters_values'=>$filters['filters_values'],'filters_condition'=>'include'];                                                                        
