...
switch ($app_module_action)
{
    case 'save':
        $sql_data = array(
            ...
            'date_fields_id' => (isset($_POST['date_fields_id']) ? $_POST['date_fields_id'] : 0),
            'number_of_days' => (isset($_POST['number_of_days']) ? $_POST['number_of_days'] : 0),
            'notes' => $_POST['notes'],
            'send_from_name' => $_POST['send_from_name'],
            'send_from_email' => $_POST['send_from_email'],
           
            // OUR NEW FIELDS
            'cc_emails' => (isset($_POST['cc_emails']) ? $_POST['cc_emails'] : ''),
            'bcc_emails' => (isset($_POST['bcc_emails']) ? $_POST['bcc_emails'] : ''),
            'send_as_group' => (isset($_POST['send_as_group']) ? 1 : 0), // <-- THIS LINE MAKES THE CHECKBOX SAVE CORRECTLY
        );
        if (isset($_GET['id']))
        {
    ...
    case 'get_entities_fields':
        ...
        if(strstr($_POST['action_type'],'schedule'))
        {
            ...
            <div class="form-group" >
                ...
                <div class="col-md-9">
                    ' . select_tag('date_fields_id', $choices, (isset($obj['date_fields_id']) ? $obj['date_fields_id'] : 0), array('class' => 'form-control input-large required')) . '
        ...
        $html .= '
            <div class="form-group" style="margin-top: 30px;">
                ...
                <div class="col-md-9">
                    ' . select_tag('monitor_fields_id', $choices, (isset($obj['monitor_fields_id']) ? $obj['monitor_fields_id'] : 0), array('class' => 'form-control input-large ' . ($is_required ? 'required' : ''), 'onChange' => 'get_monitor_choices()')) . '
                </div>
            </div>
...
';
            ...
            case 'schedule_send_to_users':
                ...
                while ($users = db_fetch_array($users_query))
                {
                    ...
                    {
                        $group_name = (strlen(isset($users['group_name']) ? $users['group_name'] : '') > 0 ? $users['group_name'] : TEXT_ADMINISTRATOR);
